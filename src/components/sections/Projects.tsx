...
const testProjectProps: ProjectCardProps = {
    title: 'Creative Coding in p5.js',
    description:
        'A collection of miscellaneous creative coding experiments in p5.js',
    link: 'localhost:3005',
    tech: 'p5.js,Next.js,React',
};
